...
public class ItemOneAdapter extends RecyclerView.Adapter<ItemOneAdapter.ViewHolder> {
    ...
    public ItemOneAdapter(Context context,List<ListEntity.ProductItemBean.ProductItem> commodityList) {
        this.commodityList = commodityList;
        this.context =context;
    }
    @NonNull
    @Override
    public ItemOneAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item1_layout,viewGroup,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ItemOneAdapter.ViewHolder viewHolder, int i) {
