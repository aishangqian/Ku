...
public class ItemThreeAdapter extends RecyclerView.Adapter<ItemThreeAdapter.ViewHolder> {
    ...
    public ItemThreeAdapter(Context context,List<ListEntity.ProductItemBean.ProductItem> commodityList) {
        this.commodityList = commodityList;
        this.context =context;
    }
    @NonNull
    @Override
    public ItemThreeAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item3_layout,viewGroup,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ItemThreeAdapter.ViewHolder viewHolder, int i) {
